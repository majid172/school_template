        ...
        <div class="relative h-[350px] overflow-hidden rounded-2xl md:h-[500px]">
            ...
            <div class="hidden duration-700 ease-in-out" data-carousel-item>
                <div class="relative w-full h-full">
                    ...
                    <div class="absolute inset-0 flex items-end justify-center px-4 pb-16 md:pb-24">
                        <h5
                            class="banner-title text-white text-2xl md:text-4xl font-bold leading-tight max-w-4xl text-center opacity-0">
                            {{ $item->title }}
                        </h5>
                    </div>
                </div>
                ...
                <section>
                    <div class="relative flex flex-col md:flex-row items-center">
                        ...
                        <div class="w-full md:w-3/5 flex-shrink-0">
                            <img src="{{ ($about && $about->image) ? 'data:image/jpeg;base64,' . base64_encode($about->image) : asset('assets/images/campus.jpg') }}"
                                alt="School Building" class="w-full h-80 object-cover rounded-xl shadow-md">

                        </div>
                        <!-- Text Box -->
                        <div
                            class="w-full md:w-3/5 bg-white p-8 rounded-xl shadow-lg md:-ml-20 mt-[-40px] md:mt-0 relative z-10">
                            <h2 class="text-2xl font-bold text-gray-800 mb-4">{{ $about->title ?? 'About Our School' }}
                            </h2>
                            <p class="text-gray-600 leading-relaxed text-sm mb-6">{{ $about->short_description ??
                                'Welcome to our institution. We are dedicated to providing quality education and
                                fostering potential in every child.' }}</p>
                            <a href="{{ route('about') }}"
                        ...
                        <div class="bg-white p-6 rounded-xl border border-gray-200">
                            <div class="flex gap-4">
                                <img src="data:image/jpeg;base64,{{ base64_encode($item->photo) }}"
                                    alt="{{ $item->name }}" class="w-24 h-24 rounded-full object-cover flex-shrink-0" />
        ...
        <div class="flex flex-wrap justify-center gap-8">
            ...
            <div
                ...
                <div class="flex-shrink-0">
                    <img src="data:image/jpeg;base64,{{ base64_encode($item->photo) }}" alt="{{ $item->name_en }}"
                ...
                <div class="flex flex-col h-full w-full">
                    ...
                    <div class="flex items-center gap-2 mb-4">
                        ...
                        <a href="#" class="bg-green-500 text-white p-2 rounded-md hover:bg-green-600 transition-colors">
                            <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                                <path
            ...
            <div
                ...
                <div class="p-6 flex flex-col flex-grow">
                    <div class="flex justify-between items-center text-sm text-gray-500 mb-3">
                        <span class="font-medium">Post by: <span class="text-slate-800 font-semibold">{{ $item->author
                                }}</span></span>
...
<style>
    ...
    /* Reset state for hidden items to allow re-triggering */
    [data-carousel-item].hidden .banner-title {
        animation: none;
        opacity: 0;
        transform: translateY(150px);
    }

    /* Trigger animation when not hidden */
    [data-carousel-item]:not(.hidden) .banner-title {
        animation: slideUp 1.2s cubic-bezier(0.25, 0.46, 0.45, 0.94) 0.6s forwards;
    }
