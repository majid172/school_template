<header class="bg-white sticky top-0 z-50 shadow-sm">
    <nav class="container mx-auto px-4 py-3 flex justify-between items-center">
        ...
        <div class="hidden lg:flex items-center space-x-8 text-gray-700 font-medium">
            <a href="{{ url('/') }}" class="bg-teal-600 text-white px-4 py-2 rounded-full">মূলপাতা</a>
            ...
            <div class="relative group">
                ...
                <div class="absolute top-full left-1/2 -translate-x-1/2 mt-2 w-48 bg-white rounded-md shadow-lg py-1 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 z-10 border border-gray-100">
                    ...
                    <a href="{{ url('speech') }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 hover:text-brand-green">পরিচালকের বার্তা </a>
                </div>
            </div>
        ...
        <!-- Login Button -->
        <a href="javascript:void(0)" class="bg-teal-600 text-white px-6 py-2 rounded-md font-semibold flex items-center space-x-2">
